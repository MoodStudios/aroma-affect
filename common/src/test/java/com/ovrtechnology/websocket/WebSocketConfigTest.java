...
class WebSocketConfigTest {
    ...
    class UriGeneration {
        ...
        void shouldBuildWsUri() {
            WebSocketConfig config =
                    WebSocketConfig.builder().host("example.com").port(9000).secure(false).build();
        ...
        void shouldIncludePathInUri() {
            WebSocketConfig config =
                    WebSocketConfig.builder().host("localhost").port(8080).path("/api/ws").build();
        ...
        void shouldAddLeadingSlashToPath() {
            WebSocketConfig config =
                    WebSocketConfig.builder().host("localhost").port(8080).path("socket").build();
    ...
    class Builder {
        ...
        void shouldSupportToBuilder() {
            WebSocketConfig original =
                    WebSocketConfig.builder().host("original.host").port(1000).build();

            WebSocketConfig modified = original.toBuilder().port(2000).build();
