...
public final class NoseMaskModel extends HumanoidModel<HumanoidRenderState> {
    ...
    public static LayerDefinition createLayer() {
        ...
        // Required HumanoidModel parts (empty)
        ...
        // Nose mask attached to head - exported from Blockbench with Box UV
        // The nose_mask is offset to align with the player's head (Y=1.0F from Blockbench)
        PartDefinition noseMask = head.addOrReplaceChild("nose_mask",
                CubeListBuilder.create()
                        .texOffs(0, 8)
                        .addBox(-1.0F, -4.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 1.0F, 0.0F));

        // Strap (String group from Blockbench)
        PartDefinition strap = noseMask.addOrReplaceChild("strap",
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-8.5F, -1.0F, 4.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 0)
                        .addBox(-8.5F, -1.0F, -4.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(4.5F, -2.0F, -0.5F));

        // Right strap piece (rotated)
        strap.addOrReplaceChild("strap_right",
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-4.5F, -1.0F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        // Left strap piece (rotated)
        strap.addOrReplaceChild("strap_left",
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-4.5F, -1.0F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-9.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        // Extras group (wings and details)
        PartDefinition extras = noseMask.addOrReplaceChild("extras",
                CubeListBuilder.create(),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        // Detail Bottom
        extras.addOrReplaceChild("detail_bottom",
                CubeListBuilder.create()
                        .texOffs(8, 14)
        ...
        // Right Wing
        extras.addOrReplaceChild("right_wing",
                CubeListBuilder.create()
                        .texOffs(16, 8)
        ...
        // Right Back Wing
        extras.addOrReplaceChild("right_back_wing",
                CubeListBuilder.create()
                        .texOffs(0, 20)
        ...
        // Left Back Wing
        extras.addOrReplaceChild("left_back_wing",
                CubeListBuilder.create()
                        .texOffs(0, 19)
                        .addBox(0.0F, -5.0F, 0.0F, 4.0F, 6.0F, 0.01F, new CubeDeformation(0.0F)),
        ...
        // Left Wing
        extras.addOrReplaceChild("left_wing",
                CubeListBuilder.create()
                        .texOffs(8, 8)
                        .addBox(0.0F, -5.0F, 0.0F, 4.0F, 6.0F, 0.01F, new CubeDeformation(0.0F)),
